  ...
  return (
    <main className="container mx-auto p-4 sm:p-6 lg:p-8">
        <header className="mb-8">
            <Link to="/" className="text-brand-blue dark:text-brand-accent hover:underline mb-4 inline-block">&larr; Back to Dashboard</Link>
            <h1 className="text-4xl font-bold">{student.name}</h1>
            <p className="text-gray-500 dark:text-gray-400 mt-1">Codeforces Handle: <a href={`https://codeforces.com/profile/${student.codeforces_handle}`} target="_blank" rel="noopener noreferrer" className="text-brand-blue dark:text-brand-accent hover:underline">{student.codeforces_handle}</a></p>
             <p className="text-sm text-gray-400 mt-1">Last Synced: {student.last_updated ? new Date(student.last_updated).toLocaleString() : 'Never'}</p>
        </header>

        <div className="space-y-8">
            <section>
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-2xl font-semibold">Contest History</h2>
                ...
                <div className="p-4 border dark:border-slate-700 rounded-lg bg-gray-50 dark:bg-slate-900">
            ...
            <section>
                <h2 className="text-2xl font-semibold mb-4 border-b pb-2 dark:border-slate-700">Problem Solving Data</h2>
                <div className="p-4 border dark:border-slate-700 rounded-lg bg-gray-50 dark:bg-slate-900">
                    <h3 className="text-xl font-semibold mb-4 text-center">Submission Heatmap (Last Year)</h3>
